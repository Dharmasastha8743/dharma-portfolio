    ...
    <div className="bg-gray-100 min-h-screen p-6 text-gray-800">
      ...
      <section className="mb-10">
        ...
        <div className="bg-white p-4 rounded-2xl shadow mb-4">
          ...
          <a href="https://firds.exchange-data.co.in/" className="text-blue-500 underline mt-2 block" target="_blank">View Project</a>
        </div>
        ...
        <div className="bg-white p-4 rounded-2xl shadow mb-4">
          ...
          <a href="https://sqxbonds.com/" className="text-blue-500 underline mt-2 block" target="_blank">View Project</a>
        </div>
      ...
      <section>
        ...
        <ul className="list-disc list-inside">
          ...
          <li>GitHub: <a href="https://github.com/Dharmasastha8743" className="text-blue-500" target="_blank">https://github.com/Dharmasastha8743</a></li>
          <li>LinkedIn: <a href="https://www.linkedin.com/in/dharmasastha-baskar-20345a242" className="text-blue-500" target="_blank">https://www.linkedin.com/in/dharmasastha-baskar-20345a242</a></li>
        </ul>
      </section>
    </div>
  );
